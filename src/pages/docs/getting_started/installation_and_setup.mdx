...
Thyseus makes use of a Typescript transformer to provide better DX. The docs
will assume you're using the transformer - if you're not, you'll need to
[review the systems docs](/docs/core_concepts/systems#systems-without-the-transformer).

The transformer requires the use of Typescript; if you don't have experience
with Typescript, it's recommended that you

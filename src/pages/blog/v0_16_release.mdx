...
Thyseus has a lot of strong points and a lot of aspects I'm very happy with.
Overall, I think working with the library is fairly straightforward. However,
there's many areas where I feel that Thyseus doesn't behave predictably, where
we break away from assumptions you can normally safely make about while working
in Javascript. For me, a Javascript ECS should embrace the language - if it
doesn't, why not just use something like Bevy and target web with WASM?
...
productivity, or all of the above. For us right now, it's all of the above; it's
not too bad in any particular area, but as a whole it makes maintenance of
Thyseus and certain parts of using it more painful than necessary.
...
-   Async patterns within systems are tricky.
...
invaluable input from [3mcd](https://github.com/3mcd)!
...
instances. There's also no need of register types ahead of time, so

...
in better performance, and in fact will usually result in _worse_ performance.
...
Pretty much! Because systems must specify the data they use and how they use it,
